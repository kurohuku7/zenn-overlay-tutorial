...
## GetTrackedDeviceIndexForControllerRole() が deprecated なので別の方法でコントローラを取得したい

コメントがあったので[こちらの記事](https://zenn.dev/kurohuku/articles/get-device-index-from-action)に書きました。
